...
import url,{ getInvoiceById, addInvoice, updateInvoice,getCustomerList,ApiKey} from "../invoice/InvoiceService";
  ...
  const handleChanges = (event, newValue,index) => {
    ...
    tempItemList.map((element, i) => {
      ...
      if (index === i) 
      {
        ...
        element['product'] = newValue?.inputValue?newValue?.inputValue:newValue?.name
        ...
        <Divider />
          ...
          <TableHead>
            <TableRow className="bg-default">
              ...
              <TableCell className="px-0"  style={{width:'90px'}} align="center">ITEM </TableCell>
              ...
              <TableCell className="px-0"  style={{width:'50px'}} align="center">PRICE</TableCell>
          ...
          <TableBody>
            {invoiceItemList.map((item, index) => {
              console.log(item.product_price_list)
              if(!dstatus)
              {
